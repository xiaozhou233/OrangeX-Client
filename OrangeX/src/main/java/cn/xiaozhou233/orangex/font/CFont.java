...
public class CFont
{
    ...
    public CFont(Font font, boolean antiAlias, boolean fractionalMetrics)
    {
        ...
        this.fontImage = generateFontImage(font, antiAlias, fractionalMetrics, this.charData);
    }

    protected AbstractTexture getTexture()
    {
        if (tex == null)
        {
            tex = setupTexture(fontImage);
            fontImage = null;
        }
        return tex;
    }

    public AbstractTexture setupTexture(BufferedImage img)
    {
        try
        {
            AbstractTexture texture = new DynamicTexture(img);
    ...
    protected BufferedImage generateFontImage(Font font, boolean antiAlias, boolean fractionalMetrics, CharData[] chars)
    {
        ...
        while (true)
        {
            ...
            for (int i = 0; i < chars.length; i++)
            {
                ...
                if (positionY + charData.height >= imgSize)
                {
                    overflow = true;
                    break;
                }
    ...
    public void setAntiAlias(boolean antiAlias)
    {
        ...
        {
            this.antiAlias = antiAlias;
            this.fontImage = generateFontImage(this.font, antiAlias, this.fractionalMetrics, this.charData);
            this.tex = null;
        }
    }
    ...
    public void setFractionalMetrics(boolean fractionalMetrics)
    {
        ...
        {
            this.fractionalMetrics = fractionalMetrics;
            this.fontImage = generateFontImage(this.font, this.antiAlias, fractionalMetrics, this.charData);
            this.tex = null;
        }
    }
    ...
    {
        this.font = font;
        this.fontImage = generateFontImage(font, this.antiAlias, this.fractionalMetrics, this.charData);
        this.tex = null;
    }
