...
public final class MappingReader {
    ...
    public MappingData load(LoaderType loaderType, MinecraftVersion minecraftVersion) {
        MappingData data = new MappingData();
        String loaderDir = switchLoaderDir(loaderType);
        if (loaderDir == null) {
            System.out.println("[DEBUG] No need to load mapping file");
            return data;
        }

        String versionDir = switchVersionDir(minecraftVersion);
        if (versionDir == null) {
            System.out.println("[DEBUG] Version not supported: " + minecraftVersion.name());
            return data;
        }
    ...
    private String switchVersionDir(MinecraftVersion minecraftVersion) {
        switch (minecraftVersion) {
            case V1_8_9: return "189";
            case V1_12_2: return "1122";
            case V26_2: return "262";
            default: return null;
        }
    }
